                ...
                <header className="header-glow flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-4">
                        ...
                        <button
                            ...
                            className="inline-flex items-center px-4 py-2 rounded-lg bg-white dark:bg-dark-surface text-gray-700 dark:text-dark-text shadow hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:focus:ring-dark-accent"
